...
import com.alura.literalura.services.ConsumeAPI;
import com.alura.literalura.services.DataConversion;
import com.alura.literalura.validator.Validator;
...
public class LiteraluraApp implements ILiteraluraApp{
    ...
    public void showBooks() {
        ...
        listBooks = dataResults.dataBooks().stream()
                .filter(dataBook -> !dataBook.autores().isEmpty()) // Asegura que los autores existen
                .map(dataBook -> new Books(dataBook, dataBook.autores().get(0)))
